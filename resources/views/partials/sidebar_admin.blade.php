<div class="col-md-2 col-sm-2">
    ...
    <div class="card bg-light">
        ...
        <div class="card-body">
            ...
            <div class="menu-item mb-2">
                <div class="dropdown">
                    <a class="text-decoration-none text-dark d-flex align-items-center dropdown-toggle" id="addBusiness" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-building me-2"></i> Xét duyệt công ty
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="addBusiness">
                        <li>
                            <a href="{{ route('admin.home.buspending') }}" class="dropdown-item">
                                Danh sách đang chờ duyệt
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.home.busapproved') }}" class="dropdown-item">
                                Danh sách đã duyệt
                            </a>
                        </li>
                    </ul>
