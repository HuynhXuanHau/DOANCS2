<div class="col-md-2 col-sm-2">
    ...
    <div class="card bg-light">
        <div class="card-header text-center">
            <a href="{{ url('/business/home') }}" class="text-decoration-none text-dark">
        ...
        <div class="card-body">
            ...
            <div class="menu-item mb-2">
                <a href="{{ route('business.home.pending') }}" class="text-decoration-none text-dark d-flex align-items-center">
                    <i class="fa-solid fa-clock me-2"></i> Danh sách chờ duyệt
                </a>
            </div>
            <div class="menu-item mb-2">
                <a href="{{ route('business.home.approved') }}" class="text-decoration-none text-dark d-flex align-items-center">
                    <i class="fa-solid fa-check-to-slot me-2"></i> Danh sách đã duyệt
                </a>
            </div>
            <div class="menu-item mb-2">
                <a href="{{route('business.home.interview') }}" class="text-decoration-none text-dark d-flex align-items-center">
