...
@section('content')
<div class="container-fluid " style="width:100% ;margin-top: 6%">
    ...
    <div class="container_Business bg">
        ...
        <div id="section1" style="background-color: #fff;">
            <div class="container">
                <h3 class="text-center" style="color: black;">CÁC CÔNG VIỆC HẤP DẪN</h3>
                <div class="col rounded mx-auto">
                    <div class="card rounded">
                        <div class="card-body card-body_1">
                            <!-- Include Job List Component -->
        ...
        <div class="container" id="section3">
            ...
            <div class="row ">
                <div class="col-sm-4  " style="height: 480px;">
                    <div class="card rounded">
                        <a href="#" class="text-decoration-none text-dark">
                            <img src="../images/blog-1.jpg" alt="Blog-1" width="100%" height="300px"
                                class=" rounded">
                            <div class="card-body">
                ...
                <div class="col-sm-4" style="height: 480px;">
                    <div class="card">
                        <a href="#" class="text-decoration-none text-dark">
                            <img src="../images/trangphuc.jpg" alt="Blog-1" width="100%" height="300px"
                                class="rounded">
                            <div class="card-body">
