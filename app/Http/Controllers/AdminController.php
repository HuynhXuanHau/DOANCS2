...
class AdminController extends Controller
{
    ...
    public function buspendingList()
    {
        $results = Business::where('state', 'Waiting')->get();
        return view('admin.check_business', compact('results'))->with('state', 'Waiting');
    }

    
    public function busapprovedList()
    {
        $results = Business::where('state', 'Yes')->get();
        return view('admin.check_business', compact('results'))->with('state', 'Yes');
    }
